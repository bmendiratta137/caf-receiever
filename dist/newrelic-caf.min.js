  ...
  static send(event, data) {
    if (Core.getBackend() == undefined || !(Core.getBackend() instanceof _backend.default)) {
      ...
      if (typeof newrelic !== 'undefined' && newrelic.addPageAction) {
        ...
        if (!isErrorShown) {
          _log.default.error('newrelic.addPageAction() is not available.', 'In order to use NewRelic Video you will need New Relic Browser Agent.');
          isErrorShown = true;
        }
      }
    } else {
...
class NRInsightsBackend extends _backend.default {
  ...
  constructor(accountId, apiKey) {
    let eventType = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 'BrowserVideo';
    super();
...
exports["default"] = void 0;
var pkg = _interopRequireWildcard(__webpack_require__(/*! ../package.json */ "./node_modules/newrelic-video-core/package.json"));
var _emitter = _interopRequireDefault(__webpack_require__(/*! ./emitter */ "./node_modules/newrelic-video-core/src/emitter.js"));
var _chrono = _interopRequireDefault(__webpack_require__(/*! ./chrono */ "./node_modules/newrelic-video-core/src/chrono.js"));
function _interopRequireDefault(e) { return e && e.__esModule ? e : { default: e }; }
...
var _default = exports["default"] = sendLog;
...
class CAFTracker extends nrvideo.VideoTracker {
  ...
  constructor() {
    super();
    (0, _logger.default)('CAFTracker initialized - 1');
    this.reset();
    (0, _logger.default)('CAFTracker initialized - 2');
    this.registerListeners();
    (0, _logger.default)('CAFTracker initialized - 3');
  }
  registerListeners() {
    /** CORE Events */
    ...
    (0, _logger.default)('CAFTracker initialized - 4');
    /** DEBUG Events */
...
module.exports = /*#__PURE__*/JSON.parse('{"name":"newrelic-caf","version":"0.6.0","description":"New Relic tracker for CAF Receivers","main":"src/index.js","scripts":{"build":"webpack -p","build:dev":"webpack --mode development","watch":"webpack -p --progress --color --watch","watch:dev":"webpack --progress --color --watch","prezip":"npm run build","zip":"zip -P newrelic -x \'*.DS_Store\' \'samples/agent.js\' \'*.map\' -r caf.zip dist samples README.md CHANGELOG.md EULA.md","clean":"rm -rf dist *.zip"},"author":"Andreu Santarén Llop","license":"MIT","dependencies":{"@types/chromecast-caf-receiver":"^6.0.20","newrelic-video-core":"github:newrelic/video-core-js"},"devDependencies":{"babel-core":"^6.25.0","babel-loader":"^9.1.3","babel-preset-env":"^1.6.0","webpack":"^5.94.0","webpack-cli":"^5.1.4"}}');
